...
Private Sub Command1_Click()    'sofort weiter und löschen
    ...
    If Label1.Caption = "Komprimierung" Then
    
        lbl6(1).Visible = True
        Me.Refresh
        For i = 14 To 0 Step -1
            lbl6(1).Caption = "noch ... " & j & ":" & Format(i, "0#") & " Minuten "
            lbl6(1).Refresh
            Pause 1
        Next i
        gbnachkomp = True
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Sub Command2_Click() 'warten
    On Error GoTo LOKAL_ERROR
