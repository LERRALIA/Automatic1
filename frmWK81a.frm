...
Begin VB.Form frmWK81a 
   BackColor       =   &H00C0C000&
   Caption         =   "Termine - Behandlungen"
   ClientHeight    =   8610
   ClientLeft      =   1995
   ClientTop       =   750
   ClientWidth     =   11910
   Icon            =   "frmWK81a.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   End
End
Attribute VB_Name = "frmWK81a"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Option Explicit
Dim SpaltennummerNR As Byte
Private Function fnPruefeEingabeWK81a() As Integer
    On Error GoTo LOKAL_ERROR
    
    fnPruefeEingabeWK81a = 0
    
    If Trim$(Text1(0).Text) = "" Then
        fnPruefeEingabeWK81a = 1
        Exit Function
    End If
    
    If Trim$(Text1(1).Text) = "" Then
        fnPruefeEingabeWK81a = 2
        Exit Function
    End If
    
    If Val(Text1(1).Text) > 500 Then
        fnPruefeEingabeWK81a = 3
        Exit Function
    End If
    
    If Trim$(Text1(2).Text) = "" Then
        fnPruefeEingabeWK81a = 4
        Exit Function
    End If
    
    'pr¸fen, ob es die Bezeichnung schon gibt
    'Text1(0).text
    ...
    sSQL = " Select BEZEICH from TERM_STD where BEZEICH = '" & Trim$(Text1(0).Text) & "'"
    Set rsrs = gdBase.OpenRecordset(sSQL)
    If Not rsrs.EOF Then
    
        If rsrs.RecordCount > 0 Then
            fnPruefeEingabeWK81a = 5
...
LOKAL_ERROR:
    ...
    Fehler.gsFunktion = "fnPruefeEingabeWK81a"
    Fehler.gsFehlertext = "Im Programmteil Vorgaben Behandlungen ist ein Fehler aufgetreten."
    
    Fehlermeldung1
End Function
Private Sub Zeige_Daten_81a()
On Error GoTo LOKAL_ERROR

    Tabcheck "TERM_STD"
    FormatGridOverTablay "TERM_STD"
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "Zeige_Daten_81a"
    Fehler.gsFehlertext = "Im Programmteil Vorgaben Behandlungen ist ein Fehler aufgetreten."
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Sub FuellenMShFlex1WKL81a()
    On Error GoTo LOKAL_ERROR
    ...
    sSQL = "Select * from TERM_STD order by gliederung, bezeich"
    Set rsrs = gdBase.OpenRecordset(sSQL)
            ...
            For i = 0 To byAnzahlSpalten - 1
                ...
                If sSpaltenname(i) = MSHFLEX1.Text Then
                    ...
                    Select Case sSpaltenname(i)
                        Case Is = "Listen - EK", "KVK regul‰r", "KVK Aktion", "Schnitt - EK"
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "FuellenMShFlex1WKL81a"
    Fehler.gsFehlertext = "Im Programmteil Vorgaben Behandlungen ist ein Fehler aufgetreten."
...
Private Sub HoleDatenWK81a(sNR As String)
    On Error GoTo LOKAL_ERROR
    ...
    cSQL = "Select * from TERM_STD where NR = " & sNR & " "
    Set rsrs = gdBase.OpenRecordset(cSQL)
    If Not rsrs.EOF Then
        If Not IsNull(rsrs!nr) Then
            Text1(2).Text = rsrs!nr
        Else
            Text1(2).Text = ""
        End If
        
        If Not IsNull(rsrs!Gliederung) Then
            Combo2.Text = rsrs!Gliederung
        Else
            Combo2.Text = ""
        End If
        If Not IsNull(rsrs!BEZEICH) Then
            Text1(0).Text = rsrs!BEZEICH
        Else
            Text1(0).Text = ""
        End If
        If Not IsNull(rsrs!DAUER) Then
            Text1(1).Text = rsrs!DAUER
        Else
            Text1(1).Text = ""
        End If
        
        If Not IsNull(rsrs!artnr) Then
            Text1(3).Text = rsrs!artnr
        Else
            Text1(3).Text = ""
        End If
    Else
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Sub LoescheDatenWK81a(sNR As String)
    On Error GoTo LOKAL_ERROR
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "LoescheDatenWK81a"
    Fehler.gsFehlertext = "Im Programmteil Vorgaben Behandlungen ist ein Fehler aufgetreten."
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Function
Private Sub LeereFelderWK81a()
    On Error GoTo LOKAL_ERROR
    
    Text1(0).Text = ""
    Text1(1).Text = ""
    Text1(2).Text = ermMaxNr_Term
    fuellecombo
    Text1(3).Text = ""
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "LeereFelderWK81a"
    Fehler.gsFehlertext = "Im Programmteil Vorgaben Behandlungen ist ein Fehler aufgetreten."
    
    Fehlermeldung1
End Sub
Private Sub SchreibeDatenWK81a()
    On Error GoTo LOKAL_ERROR
    ...
    Dim cGliederung As String
    Dim cArtNr As String
    
    cNr = Text1(2).Text
    cBezeich = Text1(0).Text
    cDauer = Text1(1).Text
    cGliederung = Combo2.Text
    cArtNr = Val(Text1(3).Text)
    
    cSQL = "Select * from TERM_STD where NR = " & cNr & " "
    Set rsrs = gdBase.OpenRecordset(cSQL)
    If Not rsrs.EOF Then
        rsrs.Edit
    Else
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "SchreibeDatenWK81a"
    Fehler.gsFehlertext = "Im Programmteil Vorgaben Behandlungen ist ein Fehler aufgetreten."
...
Private Sub Command0_Click(Index As Integer)
    ...
    If Index <> 58 Then
        If Label0.Caption = 4 Then
            Combo2.Text = Combo2.Text & Command0(Index).Caption
        Else
...
Private Sub Command1_Click(Index As Integer)
    ...
    Select Case Index
        Case Is = 0     'Speichern
            iRet = fnPruefeEingabeWK81a()
            Select Case iRet
                Case Is = 0     'alles okay
                    SchreibeDatenWK81a
                    fuellecombo
                Case Is = 1     'keine Bezeichnung
                    MsgBox "Bitte den Text angeben!", vbInformation, "Winkiss Hinweis:"
                    Text1(0).SetFocus
                Case Is = 2     'keine Dauer
                    MsgBox "Bitte die Behandlungsdauer angeben!", vbInformation, "Winkiss Hinweis:"
                    Text1(1).SetFocus
                Case Is = 3     'Dauer zu groﬂ
                    MsgBox "Der eingegebene Wert ist zu groﬂ!", vbInformation, "Winkiss Hinweis:"
                    Text1(1).SetFocus
                Case Is = 4     'keine Nummer
                    MsgBox "Bitte geben Sie eine Nummer an!", vbInformation, "Winkiss Hinweis:"
                    Text1(2).SetFocus
                Case Is = 5    'schon vorhanden, Bezeichnung
                    MsgBox "Diese Bezeichnung ist leider schon vergeben!", vbInformation, "Winkiss Hinweis:"
                    Text1(0).SetFocus
            End Select
        Case Is = 1     'Ausw‰hlen
            If MSHFLEX1.Row < 1 Then
                ...
                Exit Sub
            End If
            sNR = Trim(MSHFLEX1.TextMatrix(MSHFLEX1.Row, SpaltennummerNR))
        ...
        Case Is = 2     'Lˆschen
            ...
            End If
            sNR = Trim(MSHFLEX1.TextMatrix(MSHFLEX1.Row, SpaltennummerNR))
            LoescheDatenWK81a sNR
        Case Is = 8     'drucken
        
            drucke_Behandlungstexte
            
        Case Is = 5     'Feld leeren
            If Label0.Caption = 4 Then
                Combo2.Text = ""
                Combo2.SetFocus
            Else
...
End Sub
Private Sub WKL81aPositionieren()
    On Error GoTo LOKAL_ERROR
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "WKL81aPositionieren"
    Fehler.gsFehlertext = "Im Programmteil Vorgaben Behandlungen ist ein Fehler aufgetreten."
...
Private Sub fuellecombo()
    ...
    If Not rsrs.EOF Then
        ...
        Do While Not rsrs.EOF
            If Not IsNull(rsrs!Gliederung) Then
                Combo2.AddItem rsrs!Gliederung
                If Combo2.Text = "" Then
                    Combo2.Text = rsrs!Gliederung
                End If
            End If
