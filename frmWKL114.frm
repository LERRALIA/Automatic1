...
Begin VB.Form frmWKL114 
   Caption         =   "Nein Verkäufe"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   ...
   Begin VB.Label Label1 
      BackColor       =   &H80000001&
      Caption         =   "Nein Verkäufe von heute"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
...
LOKAL_ERROR:
    ...
    Fehler.gsFehlertext = "Im Programmteil Nein Verkäufe ist ein Fehler aufgetreten."
...
Private Function speichern() As Boolean
    ...
    If Not bFound Then
        anzeige "rot", "Bitte markieren Sie den Grund des Nein Verkaufs", lbl1
        Exit Function
    End If
    
    For lcount = 0 To List1.ListCount - 1
        If List1.Selected(lcount) = True Then
            cAENART = List1.list(lcount)
        End If
    Next lcount
    ...
    Else
        If IsNumeric(Text1(0).Text) Then
            cArtNr = Text1(0).Text
        Else
            anzeige "rot", "Bitte geben Sie hier eine Zahl ein!", lbl1
            Text1(0).SetFocus
            Exit Function
        End If
    End If
    ...
    If Text1(1).Text = "" Then
        anzeige "rot", "Bitte geben Sie eine Artikelbezeichnung ein!", lbl1
        Text1(1).SetFocus
        Exit Function
    Else
        cBez = Text1(1).Text
...
Private Sub fuellelist2()
    ...
    cSQL = "Select * from NEINVK where adate = " & CLng(DateValue(Now)) & " order by azeit desc"
...
Private Sub fuelleliste()
    ...
    List1.AddItem "wird in diesem Geschäft nicht geführt"
    List1.AddItem "in diesem Geschäft nicht im Bestand, aber in anderen Filialen"
    List1.AddItem "in diesem Geschäft nicht im Bestand, aber im Hauptgeschäft(Zentrale)"
    List1.AddItem "im gesamten Unternehmen nicht im Bestand"
    List1.AddItem "gehört nicht zu unserer Produktpalette"
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Sub fuelleart(cART As String)
    On Error GoTo LOKAL_ERROR
    ...
    Text1(1).Text = bezis(Text1(0).Text)
    
    Text1(3).Text = "1"

    Label1(6).Caption = ermfromBed("BEDNAME", gcBedienerNr)
