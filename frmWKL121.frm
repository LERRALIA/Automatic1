...
Begin VB.Form frmWKL121 
   Caption         =   "Preislagenstatistik/PGN"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "frmWKL121.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8595
...
On Error GoTo LOKAL_ERROR
    ...
    Select Case Index
        ...
        Case 2
            ...
            Else
                delPreislage CByte(Right(List1.list(List1.ListIndex), 3))
                sortPreislage
        ...
        Case 4
            ...
            ElseIf Option1(2).Value Then
                byso = 2
            End If
            ermittelnPL byso, lbl1, Text2(0), List3, "PGN", Text1(0), Text1(1), cboPreisl
        
        Case 5
            If List1.ListIndex < 0 Then
                anzeigeNew "rot", "Bitte einen Eintrag in der Liste markieren!", lbl1
            Else
                wählePreislage Text2(2), Text2(3), List1
            End If
        Case 6
            füllePreislagestandard cboPreisl
            zeigePreislage List1
    End Select
...
Private Sub Command2_Click()
    ...
    speicherPreislage Text2(2), Text2(3), lbl1
...
Private Sub Form_Load()
    ...
    füllePreislage cboPreisl
    
    cboFil.Clear
    cboFil.AddItem "alle Filialen"
    cboFil.Text = "alle Filialen"
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Sub PositionierenWKL29()
    On Error GoTo LOKAL_ERROR
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "PositionierenWKL29"
    Fehler.gsFehlertext = "In der Preislagenstatistik ist ein Fehler aufgetreten."
...
LOKAL_ERROR:
    ...
    Fehler.gsFehlertext = "Im Programmteil Preislagenstatistik ist ein Fehler aufgetreten."
