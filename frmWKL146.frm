...
Begin VB.Form frmWKL146 
   Caption         =   "Emailadresse der Stammdatenpflege"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "frmWKL146.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8595
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.Label Label5 
         BackColor       =   &H00C0C000&
         Caption         =   "Telefonnummer der Stammdatenpflege:"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label Label5 
         BackColor       =   &H00C0C000&
         Caption         =   "vorhandene Emailadressen:"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label Label5 
         BackColor       =   &H00C0C000&
         Caption         =   "Geben Sie hier die Emailadresse und Telefonnummer ihrer Stammdatenpflege ein!"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   12
            Charset         =   0
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Sub entfernen(cAlias As String)
    On Error GoTo LOKAL_ERROR
    ...
    sSQL = "Delete from  EMAIL where Alias like '" & cAlias & "*'"
    sSQL = sSQL & " and Thema = 'STADA'"
...
Private Sub hinzufuegen()
    ...
    If Text3(0).Text = "" Then
        Exit Sub
    Else
        cAdresse = Trim(Text3(0).Text)
    End If
    
    If Text3(5).Text = "" Then
        cAlias = cAdresse
    Else
        cAlias = Trim(Text3(5).Text)
    End If
    
    sSQL = "INSERT into EMAIL (Adresse,Alias,Thema,LASTDATE) values "
    sSQL = sSQL & " ('" & cAdresse & "','" & cAlias & "','STADA', '" & DateValue(Now) & "')"
    gdBase.Execute sSQL, dbFailOnError
...
Select Case Index
    ...
    Case 0
        ...
        fuelleEmail
    Case 1
        gsHelpstring = "Emailadresse der Stammdatenpflege"
        frmWKL110.Show 1
    Case 2
        Unload frmWKL146
    Case 3
        ...
        If List1.ListIndex < 0 Then
            MsgBox "Bitte eine Adresse auswählen!", vbInformation, "Winkiss Hinweis:"
            List1.SetFocus
        Else
            entfernen Trim(Left(List1.list(List1.ListIndex), 25))
            fuelleEmail
        End If
End Select
...
On Error GoTo LOKAL_ERROR
    ...
    List1.Clear
    List2.Clear
    List2.AddItem "angezeigter Name             Emailadresse"
    ...
    If Not rsrs.EOF Then
        ...
        Do While Not rsrs.EOF
            ...
            If Len(cFeld) > 25 Then
                cFeld = Left(cFeld, 25) & "..."
            End If

            cSatz = cFeld & Space(28 - Len(cFeld)) & Space(1)
            ...
            cSatz = cSatz & cFeld & Space(38 - Len(cFeld)) & Space(1)
