...
Begin VB.Form frmWKL162 
   ...
   Begin VB.Frame Frame6 
      ...
      Begin VB.Label Label1 
         BackColor       =   &H80000001&
         Caption         =   "ab einem Schwerpunkt in %"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label Label1 
         BackColor       =   &H80000001&
         Caption         =   "Alle Kunden anzeigen, die bevorzugt Produkte bei diesem Lieferanten kaufen"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   12
            Charset         =   0
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Sub alleKundenLinrSchwerpunkt()
On Error GoTo LOKAL_ERROR
...
'    sSQL = sSQL & " , A.BELEGNR  "
    sSQL = sSQL & " , A.adate  "
    sSQL = sSQL & " from KUNDKASS A inner join Artlief B "
    sSQL = sSQL & " on a.artnr = b.artnr "
    sSQL = sSQL & " where b.LINR = " & Trim$(Text1(13).Text) & " "
    gdBase.Execute sSQL, dbFailOnError
    
    anzeige "normal", "Daten werden ermittelt 1...", lblAnzeige
    
    sSQL = " update KUNB a inner join artikel b on a.artnr = b.artnr "
    sSQL = sSQL & " set A.ekpr = b.ekpr "
    sSQL = sSQL & " , A.mwst = b.MWST "
    gdBase.Execute sSQL, dbFailOnError
    
    anzeige "normal", "Daten werden ermittelt 2...", lblAnzeige
    ...
    anzeige "normal", "Daten werden ermittelt 3...", lblAnzeige
    
    sSQL = " Create index  MWST on KUNB(MWST) "
    gdBase.Execute sSQL, dbFailOnError
    
    anzeige "normal", "Daten werden ermittelt 4...", lblAnzeige
    ...
    anzeige "normal", "Daten werden ermittelt 5...", lblAnzeige
    ...
    anzeige "normal", "Daten werden ermittelt 6...", lblAnzeige
    ...
    sSQL = sSQL & " and Preis <> 0 "
    gdBase.Execute sSQL, dbFailOnError
    anzeige "normal", "Daten werden ermittelt 7...", lblAnzeige
    
    sSQL = "Update KUNB set rertrag = ((Preis * 100)/(100 + " & gdMWStV & ")) - (EKPR * menge) "
    sSQL = sSQL & " where mwst = 'V' "
    gdBase.Execute sSQL, dbFailOnError
    
    anzeige "normal", "Daten werden ermittelt 8...", lblAnzeige
    
    sSQL = "Update KUNB set rertrag = ((Preis * 100)/(100 + " & gdMWStE & ")) - (EKPR * menge) "
    sSQL = sSQL & " where mwst = 'E' "
    gdBase.Execute sSQL, dbFailOnError
    
    anzeige "normal", "Daten werden ermittelt 9...", lblAnzeige
    
    sSQL = "Update KUNB set rertrag = ((Preis * 100)/(100 + " & gdMWStO & " )) - (EKPR * menge) "
    sSQL = sSQL & " where mwst = 'O' "
    gdBase.Execute sSQL, dbFailOnError
    
    anzeige "normal", "Daten werden ermittelt 10...", lblAnzeige
    ...
    anzeige "normal", "Daten werden ermittelt 11...", lblAnzeige
    
    sSQL = "Select KUNDNR, sum(rertrag) as mrertrag,sum(preis) as mpreis,sum(menge) as mmenge ,avg(ens1) as ens,0.0 as Proz into KunUMSATZ "
    sSQL = sSQL & " from KUNB group by KUNDNR "
    gdBase.Execute sSQL, dbFailOnError
    
    anzeige "normal", "Daten werden ermittelt 12...", lblAnzeige
    
    Set rsrs = gdBase.OpenRecordset("KunUMSATZ")
    If Not rsrs.EOF Then
        ...
        Do While Not rsrs.EOF
            ...
            If Not IsNull(rsrs!mpreis) Then
                dAnteil = rsrs!mpreis
            Else
                dAnteil = "0"
            End If
            ...
            anzeige "normal", cKundnr & " Umsatz: " & dSumme, lblAnzeige
...
'            rsrs!Summe = dSumme
    ...
    sSQL = "Delete from  KunUMSATZ where PROZ  < " & dProzente
    gdBase.Execute sSQL, dbFailOnError
    anzeige "normal", "Daten werden ermittelt 13...", lblAnzeige
    ...
    anzeige "normal", "Daten werden ermittelt 14...", lblAnzeige
    ...
    Select Case Index
        ...
        Case 6
            If Command1(6).Caption = "Zurück" Then
                ...
                If lWahlModus = 1 Then
                    Frame1.Visible = True
                    
                    Frame6.Visible = False
                    Frame5.Visible = False
                ElseIf lWahlModus = 2 Then
                    Frame6.Visible = True
...
Private Sub lblUeberschrift_Click()
On Error GoTo LOKAL_ERROR

    
    
    If lblUeberschrift.Caption = "Kundenbeteiligung" Then
        lblUeberschrift.Caption = "Schwerpunkt Lieferant"
        Frame5.Visible = False
        Frame1.Visible = False
    ...
    ElseIf lblUeberschrift.Caption = "Schwerpunkt Lieferant" Then
        lblUeberschrift.Caption = "Kundenbeteiligung"
        Frame5.Visible = False
        Frame6.Visible = False
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "lblUeberschrift_Click"
    Fehler.gsFehlertext = "Im Programmteil Kundenbeteiligung ist ein Fehler aufgetreten."
...
Private Sub Option1_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case Is = 11     'ak jahr
            Text2(2).Value = Format("01.01." & Year(DateValue(Now)), "DD.MM.YY")
            Text2(3).Value = Format(DateValue(Now), "DD.MM.YY")
    End Select
