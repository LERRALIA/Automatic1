...
Private Sub insertVEDESFTP(sHost As String, sUser As String, sPw As String)
    ...
    sSQL = "Delete from VEDESFTP "
    gdBase.Execute sSQL, dbFailOnError
    
    sSQL = "Insert into VEDESFTP (Host,User,pw) values  "
    sSQL = sSQL & " ('" & sHost & "'"
    sSQL = sSQL & " , '" & sUser & "'"
    sSQL = sSQL & " , '" & sPw & "'"
    sSQL = sSQL & " )"
...
Private Sub Form_Load()
    ...
    Text1(0).Text = gsVEDES_HOST
    Text1(1).Text = gsVEDES_USER
    Text1(2).Text = gsVEDES_PW
