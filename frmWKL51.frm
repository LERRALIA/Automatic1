...
Begin VB.Form frmWKL51 
   Caption         =   "Preislagenstatistik/AGN"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "frmWKL51.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8595
    ...
    Select Case Index
        ...
        Case 4
            ...
            ElseIf Option1(2).Value Then
                byso = 2
            End If
            ermittelnPL byso, lbl1, Text2(0), List3, "AGN", Text1(0), Text1(1), cboPreisl
                ...
                For lcount = 0 To 100
                    ...
                    Else
                        If gF2Prompt.cArray(lcount) <> "" Then
                            ...
                            List3.AddItem gF2Prompt.cArray(lcount)
                            Text2(Index).Text = Left(gF2Prompt.cArray(lcount), 5)
                        End If
