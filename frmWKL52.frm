...
Begin VB.Form frmWKL52 
   ...
   Begin VB.Label Label1 
      Alignment       =   1  'Rechts
      BackColor       =   &H00C0C000&
      Caption         =   "pro Zeile stehen maximal 32 Zeichen zur Verfügung!"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Sub SchreibeDatenBonTextWKL52()
    On Error GoTo LOKAL_ERROR
    ...
    For iZeilenNr = 0 To 12
        ...
        cSQL = "Select * from BONTEXT where ZEILENNR = " & Trim$(Str$(iZeilenNr)) & " "
        ...
        Else
            rsrs.AddNew
        End If
        rsrs!ZEILENNR = iZeilenNr
        rsrs!ZEILENTEXT = cZeilenText
        rsrs.Update
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "SchreibeDatenBonTextWKL52"
...
Private Sub Command4_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case Is = 4     'switch to lower case / UPPER CASE
            If Command4(4).Caption = "a>A" Then
                For lcount = 0 To 56
                    Command3(lcount).Caption = UCase$(Command3(lcount).Caption)
                Next lcount
                Command4(4).Caption = "A>a"
                Command4(5).Caption = "A>a"
            Else
                For lcount = 0 To 56
        ...
        Case Is = 5     'switch to lower case/upper case
            If Command4(5).Caption = "a>A" Then
                For lcount = 0 To 56
                    Command3(lcount).Caption = UCase$(Command3(lcount).Caption)
                Next lcount
                Command4(4).Caption = "A>a"
...
Private Sub Form_Load()
    ...
    If Not NewTableSuchenDBKombi("BONTEXT", gdBase) Then
    ...
    If Not rsrs.EOF Then
        ...
        Do While Not rsrs.EOF
            ...
            Else
                cZeilenText = ""
            End If
            Text1(iZeilenNr).Text = cZeilenText
