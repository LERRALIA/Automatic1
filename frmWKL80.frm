VERSION 5.00
Begin VB.Form frmWKL80 
   Caption         =   "Artikel Kassenpreisveränderung"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "frmWKL80.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8595
...
Private Sub Form_Load()
    ...
    List1.AddItem "Datum     Uhrzeit     Fil  Kassenpreis   Änderungsgrund       Bediener"
    If SuchedatenAHKVKPR1(gsARTNR) Then
        
        
        ZeigArtHistInList "KVKPR1PDRU", List3, gsARTNR, "Filiale , LASTDATE asc , lasttime asc"
...
Private Sub Option4_Click(Index As Integer)
    ...
    ZeigArtHistInList "KVKPR1PDRU", List3, gsARTNR, Option4(Index).Tag
'    gsARTNR = ""
Exit Sub
LOKAL_ERROR:
    Fehler.gsDescr = err.Description
