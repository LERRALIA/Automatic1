VERSION 5.00
Begin VB.Form frmWKL84 
   Caption         =   "Artikel EAN Veränderung"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   Icon            =   "frmWKL84.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8595
...
Private Sub Form_Load()
    ...
    List1.AddItem "Datum     Uhrzeit Fil Artikel                                    Änderungsgrund  Bediener"
    If SuchedatenAHEANEAN(gsARTNR) Then
        ZeigArtHistInList "EANPDRUEAN", List3, gsARTNR, "Filiale , LASTDATE asc , lasttime asc"
        
        anzeige "normal", gsARTNR, lblAnzeige
'        gsARTNR = ""
    Else
        anzeige "normal", "Keine Daten zu dieser EAN: " & gsARTNR & " gefunden", lblAnzeige
    End If
...
Private Sub Option4_Click(Index As Integer)
    ...
    ZeigArtHistInList "EANPDRUEAN", List3, gsARTNR, Option4(Index).Tag
'    gsARTNR = ""
Exit Sub
LOKAL_ERROR:
    Fehler.gsDescr = err.Description
