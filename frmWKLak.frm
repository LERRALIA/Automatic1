...
Begin VB.Form frmWKLak 
   BackColor       =   &H00C0C000&
   BorderStyle     =   3  'Fester Dialog
   Caption         =   "Eingabe Gutschein-Nummer"
   ClientHeight    =   2580
   ClientLeft      =   2055
   ClientTop       =   2865
   ClientWidth     =   7305
...
LOKAL_ERROR:
    ...
    Fehlermeldung1
End Sub
Private Function fnPruefeGutscheinNr() As Integer
    On Error GoTo LOKAL_ERROR
    ...
    If Len(ctmp) = 8 Then
        ...
        If gbGutschnrKomplett = True Then
            'der bleibt so
            'gradmann neue 13er mit führender 2 werden zu 8er Länge
        Else
            ctmp = Mid(ctmp, 2, 6)
        End If
...
LOKAL_ERROR:
    ...
    Fehler.gsNumber = err.Number
    Fehler.gsFormular = Me.name
    Fehler.gsFunktion = "fnPruefeGutscheinNr"
    Fehler.gsFehlertext = "Es ist ein Fehler aufgetreten."
            ...
            Select Case iRet
                Case Is = 0     'alles okay
                    ...
                    If Len(Text1.Text) = 8 Then
                        ...
                        Else
                            Text1.Text = Mid(Text1.Text, 2, 6)
                        End If
                    ElseIf Len(Text1.Text) = 10 Then
                    
                    End If
                    glGutschNr = Val(Text1.Text)
                    Unload frmWKLak
                    
                Case Is = 1     'keine Eingabe
                    Screen.MousePointer = 11
                    MsgBox "Bitte geben Sie die Gutscheinnummer ein!", vbCritical, "STOP!"
                    Text1.SetFocus
                    
                Case Is = 2     'Nummer bereits vorhanden
                    Screen.MousePointer = 11
                    MsgBox "Diese Gutscheinnummer ist bereits vergeben!", vbCritical, "STOP!"
                    Text1.Text = ""
                    Text1.SetFocus
                Case Is = 99    'Nummer zu kurz, Eingriff vom Anwender
                    Screen.MousePointer = 11
                    Text1.SetFocus
            End Select
...
Private Sub Form_Load()
    ...
    frmWKLak.Top = Screen.Height / 2 - frmWKLak.Height / 2
    frmWKLak.Left = Screen.Width / 2 - frmWKLak.Width / 2
    ...
    If gbOGV Then
        Label2(1).Caption = ""
    Else
        Label2(1).Caption = Format$(NewGutschein, "######0")
    End If

    Text1.Text = Label2(1).Caption
...
'    checkgutschScan Text1
    ...
    If Len(ctmp) = 13 And Left(ctmp, 1) = "2" Then
    'dann sind es Gradmann-Gutscheine,
    'wo nur die ersten 8 Stellen als Nutzziffern für Gutscheine Verwendet werden sollen.
